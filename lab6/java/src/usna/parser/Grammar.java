...
import usna.util.CollectionUtils;
...
public class Grammar {
  ...
  /**
   * Builds a PCFG using the observed counts of binary and unary
  ...
  public List<UnaryRule> getUnaryRulesByOnlyChild(String child) {
  ...
  public String toString() {
    ...
    for (String child : unaryRulesByChild.keySet()) {
      for (UnaryRule unaryRule : getUnaryRulesByOnlyChild(child)) {
