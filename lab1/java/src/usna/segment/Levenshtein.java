...
public class Levenshtein {
  final Character[] canonicalCharacters = new Character[65536];
  ...
  public Levenshtein(boolean allowTranspose) {
   ...
   */
  public Character[] asCharacterArray(String s) {
  ...
  public double score(String sourceStr, String targetStr) {
    Object[] source = asCharacterArray(sourceStr);
    Object[] target = asCharacterArray(targetStr);
    clear(source.length, target.length);
    return score(source, source.length, target, target.length);
  }
